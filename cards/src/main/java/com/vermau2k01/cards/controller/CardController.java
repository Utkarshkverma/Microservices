...
@Tag(
        name = "CRUD REST APIs for Cards in QBank",
        description = "CRUD REST APIs in QBank to CREATE, UPDATE, FETCH AND DELETE card details"
)
...
public class CardController {
    ...
    public ResponseEntity<ResponseDto> createCard(@Valid @RequestParam
        ...
        return ResponseEntity
                ...
                .body(new ResponseDto(AppConstant.STATUS_201, AppConstant.MESSAGE_201));
    }
    ...
    public ResponseEntity<ResponseDto> updateCardDetails(@Valid @RequestBody CardDto cardsDto) {
        ...
        if(isUpdated) {
            return ResponseEntity
                    ...
                    .body(new ResponseDto(AppConstant.STATUS_200, AppConstant.MESSAGE_200));
        }else{
            return ResponseEntity
                    .status(HttpStatus.EXPECTATION_FAILED)
                    .body(new ResponseDto(AppConstant.STATUS_417, AppConstant.MESSAGE_417_UPDATE));
        }
    }
    ...
    public ResponseEntity<ResponseDto> deleteCardDetails(@RequestParam
        ...
        if(isDeleted) {
            ...
            return ResponseEntity
                    .status(HttpStatus.EXPECTATION_FAILED)
                    .body(new ResponseDto(AppConstant.STATUS_417, AppConstant.MESSAGE_417_DELETE));
        }
    }
